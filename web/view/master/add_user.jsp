<%-- 
    Document   : add_user
    Created on : 03-30-2020, 05:19:29 PM
    Author     : JonaC
--%>
          ...
          <form action="users" class="col-8">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="tipo" name="tipo">
                        ...
                        List<tipousuario> list=dao.listar();
                ...
                <div class="form-group">
                    <input name="accion" value="Adduser" type="submit" id="accion" class="btn btn-danger btn-block">
